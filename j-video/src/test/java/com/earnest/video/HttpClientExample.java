...
import com.earnest.crawler.core.spider.FileSpider;
...
public class HttpClientExample {
    ...
    public static void main(String[] args) {
        ...
        HttpClientContext httpClientContext = new HttpClientContext();
        BlockingUniqueScheduler scheduler = new BlockingUniqueScheduler();
        scheduler.put(get);

        FileSpider spider = new FileSpider("d:/");
        spider.setHttpClient(httpClient);
        spider.setRequestExtractor(new RegexHttpRequestExtractor("/www/4/38-------------4-\\d+-1-iqiyi--.html"));
        spider.setHttpContext(httpClientContext);
