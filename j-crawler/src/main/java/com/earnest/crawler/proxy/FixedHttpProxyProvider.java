...
public class FixedHttpProxyProvider extends AbstractHttpProxyProvider implements Closeable {
    ...
    public FixedHttpProxyProvider(HttpUriRequest httpUriRequest, int maxHttpProxyCount, int thread, boolean periodicallyCheck) {
        this(httpUriRequest,
                maxHttpProxyCount,
                initializeHttpClient(thread),
                (ScheduledThreadPoolExecutor) Executors.newScheduledThreadPool(thread),
                periodicallyCheck);
    }

    public FixedHttpProxyProvider(HttpUriRequest httpUriRequest,
                                  int maxHttpProxyCount,
                                  CloseableHttpClient httpClient,
                                  ScheduledThreadPoolExecutor scheduledThreadPoolExecutor,
                                  boolean periodicallyCheck) {
        Assert.notNull(httpUriRequest, "httpUriRequest is required");
        Assert.notNull(httpClient, "httpClient is required");
        Assert.notNull(scheduledThreadPoolExecutor, "scheduledThreadPoolExecutor is required");
